...
[IconFile("DockablePanel.png")]
	...
	public class DockablePanel extends TitleWindow
	{
		public static const DOCKING:String = "docking";
		public static const FLOATING:String = "floating";
		public static const TOFLOATING:String = "toFloating";
		public static const TODOCKING:String = "toDocking";
		
		private var tabNav:DockableTabNavigator=null;
		...
		private var dragMouseSide:String;
		private var dockAccepter:Container;
		
		private var _dockState:String = TODOCKING;			
		...
		public function DockablePanel()
		{
			super();
			horizontalScrollPolicy = ScrollPolicy.OFF;
			verticalScrollPolicy = ScrollPolicy.OFF;
			addEventListener(CloseEvent.CLOSE,closeTab);
		}
		...
		private function closeTab(e:Event):void
		{
			tabNav.closeTab();
		}
	}
